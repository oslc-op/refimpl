...
@Path("serviceProviders/{serviceProviderId}/service1/resources")
public class ResourcesService
{
                                                    ...
                                                    @QueryParam("limit") final String limitString) throws IOException, ServletException
    {
        ...
        final List<Resource> resources = AMManager.queryResources(httpServletRequest, serviceProviderId, where, page, limit);
    ...
    public Response queryResourcesAsHtml(
                                    @PathParam("serviceProviderId") final String serviceProviderId ,
                                       @QueryParam("oslc.where") final String where,
                                       @QueryParam("page") final String pageString,
    ...
    (
         ...
         uri = "serviceProviders/{serviceProviderId}/service1/resources/selector",
         hintWidth = "0px",
         hintHeight = "0px",
         resourceTypes = {Oslc_amDomainConstants.RESOURCE_TYPE},
         usages = {}
        ...
        ) throws ServletException, IOException
    {
        try {
            ...
            if (terms != null ) {
                ...
                final List<Resource> resources = AMManager.ResourceSelector(httpServletRequest, serviceProviderId, terms);
                if (resources!= null) {
                            httpServletRequest.setAttribute("resources", resources);
    ...
    {
        try {
            Resource newResource = AMManager.createResource(httpServletRequest, aResource, serviceProviderId);
        ...
        ) throws IOException, ServletException, URISyntaxException
    {
        ...
        final Resource aResource = AMManager.getResource(httpServletRequest, serviceProviderId, resourceId);
    ...
    @Path("{resourceId}")
    @Produces({ MediaType.TEXT_HTML })
    public Response getResourceAsHtml(
        @PathParam("serviceProviderId") final String serviceProviderId, @PathParam("resourceId") final String resourceId
        ) throws ServletException, IOException, URISyntaxException
    {
        ...
        if (aResource != null) {
            ...
            RequestDispatcher rd = httpServletRequest.getRequestDispatcher("/co/oslc/refimpl/am/gen/resource.jsp");
            rd.forward(httpServletRequest,httpServletResponse);
        }
        ...
        ) throws ServletException, IOException, URISyntaxException
    {
        ...
        // Start of user code getResourceCompact_init
        ...
        if (aResource != null) {
            ...
            compact.setAbout(aResource.getAbout());
            compact.setTitle(aResource.toString());
            ...
            smallPreview.setDocument(UriBuilder.fromUri(aResource.getAbout()).path("smallPreview").build());
    ...
    @GET
    @Path("{resourceId}/smallPreview")
    @Produces({ MediaType.TEXT_HTML })
    public void getResourceAsHtmlSmallPreview(
        @PathParam("serviceProviderId") final String serviceProviderId, @PathParam("resourceId") final String resourceId
        ) throws ServletException, IOException, URISyntaxException
    {
        ...
        if (aResource != null) {
            httpServletRequest.setAttribute("aResource", aResource);
            // Start of user code getResourceAsHtmlSmallPreview_setAttributes
            // End of user code
    ...
    @Produces({ MediaType.TEXT_HTML })
    public void getResourceAsHtmlLargePreview(
        @PathParam("serviceProviderId") final String serviceProviderId, @PathParam("resourceId") final String resourceId
        ) throws ServletException, IOException, URISyntaxException
    {
        ...
        if (aResource != null) {
            httpServletRequest.setAttribute("aResource", aResource);
            // Start of user code getResourceAsHtmlLargePreview_setAttributes
            // End of user code
