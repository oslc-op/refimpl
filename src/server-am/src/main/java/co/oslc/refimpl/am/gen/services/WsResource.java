...
public class WsResource
{
    ...
    @Operation(
        summary = "GET for resources of type {'" + Oslc_amDomainConstants.RESOURCE_LOCALNAME + "'}",
        description = "GET for resources of type {'" + "<a href=\"" + Oslc_amDomainConstants.RESOURCE_TYPE + "\">" + Oslc_amDomainConstants.RESOURCE_LOCALNAME + "</a>" + "'}" +
    ...
    @Path("{id}")
    @Operation(
        summary = "DELETE for resources of type {'" + Oslc_amDomainConstants.RESOURCE_LOCALNAME + "'}",
        description = "DELETE for resources of type {'" + "<a href=\"" + Oslc_amDomainConstants.RESOURCE_TYPE + "\">" + Oslc_amDomainConstants.RESOURCE_LOCALNAME + "</a>" + "'}" +
            ", with respective resource shapes {'" + "<a href=\"" + "../services/" + OslcConstants.PATH_RESOURCE_SHAPES + "/" + Oslc_amDomainConstants.RESOURCE_PATH + "\">" + Oslc_amDomainConstants.RESOURCE_LOCALNAME + "</a>" + "'}",
        responses = {@ApiResponse(description = "default response",
            content = {@Content(mediaType = OslcMediaType.APPLICATION_RDF_XML), @Content(
                mediaType = OslcMediaType.APPLICATION_XML), @Content(
    ...
    @Operation(
        summary = "PUT for resources of type {'" + Oslc_amDomainConstants.RESOURCE_LOCALNAME + "'}",
        description = "PUT for resources of type {'" + "<a href=\"" + Oslc_amDomainConstants.RESOURCE_TYPE + "\">" + Oslc_amDomainConstants.RESOURCE_LOCALNAME + "</a>" + "'}" +
            ", with respective resource shapes {'" + "<a href=\"" + "../services/" + OslcConstants.PATH_RESOURCE_SHAPES + "/" + Oslc_amDomainConstants.RESOURCE_PATH + "\">" + Oslc_amDomainConstants.RESOURCE_LOCALNAME + "</a>" + "'}",
        responses = {@ApiResponse(description = "default response",
            content = {@Content(mediaType = OslcMediaType.APPLICATION_RDF_XML), @Content(
                mediaType = OslcMediaType.APPLICATION_XML), @Content(
