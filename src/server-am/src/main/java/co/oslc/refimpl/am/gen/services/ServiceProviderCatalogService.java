...
public class ServiceProviderCatalogService
{
    ...
    public ServiceProviderCatalog getServiceProviderCatalog()
    {
        ...
        if (catalog != null) {
            httpServletResponse.addHeader(OSLCAMServer2020RefImplConstants.HDR_OSLC_VERSION,"2.0");
            return catalog;
        }
    ...
    public void getHtmlServiceProvider(@PathParam("someId") final String someId)
    {
        ...
        if (catalog !=null )
        {
            ...
            RequestDispatcher rd = httpServletRequest.getRequestDispatcher("/co/oslc/refimpl/am/gen/serviceprovidercatalog.jsp");
            try {
