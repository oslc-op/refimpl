...
if (request.getParameter("resourceUri") != null) {
    aResource = new LinkType (new URI(request.getParameter("resourceUri")));
}
else {
    if (request.getAttribute("aLinkType") != null) {
        aResource = (LinkType) request.getAttribute("aLinkType");
    }
}

if (asLocalResource != null && asLocalResource.equalsIgnoreCase("true")) {
    out.write("{a Local LinkType Resource} - update LinkType.toString() to present resource as desired.");
}
else {
    if (aResource == null) {
