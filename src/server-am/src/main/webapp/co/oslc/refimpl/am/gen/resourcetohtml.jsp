...
if (request.getParameter("resourceUri") != null) {
    aResource = new Resource (new URI(request.getParameter("resourceUri")));
}
else {
    if (request.getAttribute("aResource") != null) {
        aResource = (Resource) request.getAttribute("aResource");
    }
}

if (asLocalResource != null && asLocalResource.equalsIgnoreCase("true")) {
    out.write("{a Local Resource Resource} - update Resource.toString() to present resource as desired.");
}
else {
    if (aResource == null) {
