...
<div class="container">
    <div class="jumbotron">
        ...
        <p class="lead">This is a homepage of the <em>AM</em> that was generated using
    ...
    <div class="alert alert-primary" role="alert">
        ...
        <hr>
        <p>This initially generated sample front page can be modified, by changing the file <code>../src/server-am/src/main/webapp/index.jsp</code></p>
        <ul>
