...
<div class="container">
    <div class="page-header">
        <h1>TestCase resource</h1>
        <p class="lead">URI:&nbsp;
        <jsp:include page="/co/oslc/refimpl/qm/gen/testcasetohtml.jsp"></jsp:include>
        </p>
    </div>
        <h2>Properties</h2>
        ...
        <div>
          ...
          <dl class="row">
            <dt  class="col-sm-2 text-right">testsChangeRequest</dt>
            <dd class="col-sm-9">
            <ul>
            <%
          ...
          <dl class="row">
            <dt  class="col-sm-2 text-right">usesTestScript</dt>
            <dd class="col-sm-9">
            <ul>
            <%
