...
if (request.getParameter("resourceUri") != null) {
    aResource = new TestPlan (new URI(request.getParameter("resourceUri")));
}
else {
    if (request.getAttribute("aTestPlan") != null) {
        aResource = (TestPlan) request.getAttribute("aTestPlan");
    }
}

if (asLocalResource != null && asLocalResource.equalsIgnoreCase("true")) {
    out.write("{a Local TestPlan Resource} - update TestPlan.toString() to present resource as desired.");
}
else {
    if (aResource == null) {
