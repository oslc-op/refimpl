...
if (request.getParameter("resourceUri") != null) {
    aResource = new ChangeRequest (new URI(request.getParameter("resourceUri")));
}
else {
    if (request.getAttribute("aChangeRequest") != null) {
        aResource = (ChangeRequest) request.getAttribute("aChangeRequest");
    }
}

if (asLocalResource != null && asLocalResource.equalsIgnoreCase("true")) {
    out.write("{a Local ChangeRequest Resource} - update ChangeRequest.toString() to present resource as desired.");
}
else {
    if (aResource == null) {
