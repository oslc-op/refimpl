...
<div class="container">
    <div class="page-header">
        <h1>TestExecutionRecord resource</h1>
        <p class="lead">URI:&nbsp;
        ...
        <div>
          ...
          <dl class="row">
            <dt  class="col-sm-2 text-right">blockedByChangeRequest</dt>
            <dd class="col-sm-9">
            <ul>
            <%
          ...
          <dl class="row">
            <dt  class="col-sm-2 text-right">runsOnTestEnvironment</dt>
            <dd class="col-sm-9">
            <%
          ...
          <dl class="row">
            <dt  class="col-sm-2 text-right">runsTestCase</dt>
            <dd class="col-sm-9">
            <%
