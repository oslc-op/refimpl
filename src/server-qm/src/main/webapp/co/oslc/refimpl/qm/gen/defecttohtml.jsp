...
if (request.getParameter("resourceUri") != null) {
    aResource = new Defect (new URI(request.getParameter("resourceUri")));
}
else {
    if (request.getAttribute("aDefect") != null) {
        aResource = (Defect) request.getAttribute("aDefect");
    }
}

if (asLocalResource != null && asLocalResource.equalsIgnoreCase("true")) {
    out.write("{a Local Defect Resource} - update Defect.toString() to present resource as desired.");
}
else {
    if (aResource == null) {
