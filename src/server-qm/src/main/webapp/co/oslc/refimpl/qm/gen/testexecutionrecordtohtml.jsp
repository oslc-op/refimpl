...
if (request.getParameter("resourceUri") != null) {
    aResource = new TestExecutionRecord (new URI(request.getParameter("resourceUri")));
}
else {
    if (request.getAttribute("aTestExecutionRecord") != null) {
        aResource = (TestExecutionRecord) request.getAttribute("aTestExecutionRecord");
    }
}

if (asLocalResource != null && asLocalResource.equalsIgnoreCase("true")) {
    out.write("{a Local TestExecutionRecord Resource} - update TestExecutionRecord.toString() to present resource as desired.");
}
else {
    if (aResource == null) {
