...
<%
  List<TestResult> resources = (List<TestResult>) request.getAttribute("resources");
...
<head>
  ...
  <title>Query capability TestResultQC</title>
...
<!-- Fixed navbar -->
  ...
  <div class="container">
    <div class="page-header">
      <h1>Query Capability &quot;TestResultQC&quot; results</h1>
      <div class="alert alert-secondary" role="alert">
        ...
        <% for (TestResult aResource : resources) { %>
