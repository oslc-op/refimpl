...
<%
  List<TestPlan> resources = (List<TestPlan>) request.getAttribute("resources");
...
<head>
  ...
  <title>Query capability TestPlanQC</title>
...
<!-- Fixed navbar -->
  ...
  <div class="container">
    <div class="page-header">
      <h1>Query Capability &quot;TestPlanQC&quot; results</h1>
      <div class="alert alert-secondary" role="alert">
        ...
        <% for (TestPlan aResource : resources) { %>
