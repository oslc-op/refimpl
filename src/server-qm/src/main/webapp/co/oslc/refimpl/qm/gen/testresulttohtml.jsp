...
if (request.getParameter("resourceUri") != null) {
    aResource = new TestResult (new URI(request.getParameter("resourceUri")));
}
else {
    if (request.getAttribute("aTestResult") != null) {
        aResource = (TestResult) request.getAttribute("aTestResult");
    }
}

if (asLocalResource != null && asLocalResource.equalsIgnoreCase("true")) {
    out.write("{a Local TestResult Resource} - update TestResult.toString() to present resource as desired.");
}
else {
    if (aResource == null) {
