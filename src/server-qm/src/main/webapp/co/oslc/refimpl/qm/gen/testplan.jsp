...
<div class="container">
    <div class="page-header">
        <h1>TestPlan: <%= aTestPlan.toString() %></h1>
        <%
        URI shapeUri = UriBuilder.fromUri(OSLC4JUtils.getServletURI()).path(OslcConstants.PATH_RESOURCE_SHAPES).path(Oslc_qmDomainConstants.TESTPLAN_PATH).build();
        Collection<URI> types = aTestPlan.getTypes();   
        %>
        ...
        <ul>
        <%for (URI type : aTestPlan.getTypes()) {%>
