...
@OslcSchema ({
    ...
    @OslcNamespaceDefinition(prefix = Oslc_cmDomainConstants.CHANGE_MANAGEMENT_SHAPES_NAMSPACE_PREFIX, namespaceURI = Oslc_cmDomainConstants.CHANGE_MANAGEMENT_SHAPES_NAMSPACE),
...
package co.oslc.refimpl.qm.gen.resources;
