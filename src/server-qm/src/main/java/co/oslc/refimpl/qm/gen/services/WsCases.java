...
public class WsCases
{
    ...
    @Operation(
        summary = "GET for resources of type {'" + Oslc_qmDomainConstants.TESTCASE_LOCALNAME + "'}",
        description = "GET for resources of type {'" + "<a href=\"" + Oslc_qmDomainConstants.TESTCASE_TYPE + "\">" + Oslc_qmDomainConstants.TESTCASE_LOCALNAME + "</a>" + "'}" +
    ...
    @Path("{spSlug}.{id}")
    @Operation(
        summary = "DELETE for resources of type {'" + Oslc_qmDomainConstants.TESTCASE_LOCALNAME + "'}",
        description = "DELETE for resources of type {'" + "<a href=\"" + Oslc_qmDomainConstants.TESTCASE_TYPE + "\">" + Oslc_qmDomainConstants.TESTCASE_LOCALNAME + "</a>" + "'}" +
            ", with respective resource shapes {'" + "<a href=\"" + "../services/" + OslcConstants.PATH_RESOURCE_SHAPES + "/" + Oslc_qmDomainConstants.TESTCASE_PATH + "\">" + Oslc_qmDomainConstants.TESTCASE_LOCALNAME + "</a>" + "'}",
        responses = {@ApiResponse(description = "default response",
            content = {@Content(mediaType = OslcMediaType.APPLICATION_RDF_XML), @Content(
                mediaType = OslcMediaType.APPLICATION_XML), @Content(
    ...
    @Operation(
        summary = "PUT for resources of type {'" + Oslc_qmDomainConstants.TESTCASE_LOCALNAME + "'}",
        description = "PUT for resources of type {'" + "<a href=\"" + Oslc_qmDomainConstants.TESTCASE_TYPE + "\">" + Oslc_qmDomainConstants.TESTCASE_LOCALNAME + "</a>" + "'}" +
            ", with respective resource shapes {'" + "<a href=\"" + "../services/" + OslcConstants.PATH_RESOURCE_SHAPES + "/" + Oslc_qmDomainConstants.TESTCASE_PATH + "\">" + Oslc_qmDomainConstants.TESTCASE_LOCALNAME + "</a>" + "'}",
        responses = {@ApiResponse(description = "default response",
            content = {@Content(mediaType = OslcMediaType.APPLICATION_RDF_XML), @Content(
                mediaType = OslcMediaType.APPLICATION_XML), @Content(
