...
public class WsPlans
{
    ...
    @Operation(
        summary = "GET for resources of type {'" + Oslc_qmDomainConstants.TESTPLAN_LOCALNAME + "'}",
        description = "GET for resources of type {'" + "<a href=\"" + Oslc_qmDomainConstants.TESTPLAN_TYPE + "\">" + Oslc_qmDomainConstants.TESTPLAN_LOCALNAME + "</a>" + "'}" +
        ...
        ) throws IOException, ServletException, URISyntaxException
    {
        ...
        final TestPlan aTestPlan = delegate.getTestPlan(httpServletRequest, spSlug, id);

        if (aTestPlan != null) {
            // Start of user code getTestPlan
            // End of user code
            httpServletResponse.setHeader("ETag", delegate.getETagFromTestPlan(aTestPlan));
    ...
    @Path("{spSlug}/{id}")
    @Operation(
        summary = "DELETE for resources of type {'" + Oslc_qmDomainConstants.TESTPLAN_LOCALNAME + "'}",
        description = "DELETE for resources of type {'" + "<a href=\"" + Oslc_qmDomainConstants.TESTPLAN_TYPE + "\">" + Oslc_qmDomainConstants.TESTPLAN_LOCALNAME + "</a>" + "'}" +
            ", with respective resource shapes {'" + "<a href=\"" + "../services/" + OslcConstants.PATH_RESOURCE_SHAPES + "/" + Oslc_qmDomainConstants.TESTPLAN_PATH + "\">" + Oslc_qmDomainConstants.TESTPLAN_LOCALNAME + "</a>" + "'}",
        responses = {@ApiResponse(description = "default response",
            content = {@Content(mediaType = OslcMediaType.APPLICATION_RDF_XML), @Content(
                mediaType = OslcMediaType.APPLICATION_XML), @Content(
        ...
        ) throws IOException, ServletException, URISyntaxException
    {
        ...
        // End of user code
        final TestPlan aResource = delegate.getTestPlan(httpServletRequest, spSlug, id);

        if (aResource != null) {
            // Start of user code deleteTestPlan
            // End of user code
            boolean deleted = delegate.deleteTestPlan(httpServletRequest, spSlug, id);
            if (deleted)
    ...
    @Operation(
        summary = "PUT for resources of type {'" + Oslc_qmDomainConstants.TESTPLAN_LOCALNAME + "'}",
        description = "PUT for resources of type {'" + "<a href=\"" + Oslc_qmDomainConstants.TESTPLAN_TYPE + "\">" + Oslc_qmDomainConstants.TESTPLAN_LOCALNAME + "</a>" + "'}" +
            ", with respective resource shapes {'" + "<a href=\"" + "../services/" + OslcConstants.PATH_RESOURCE_SHAPES + "/" + Oslc_qmDomainConstants.TESTPLAN_PATH + "\">" + Oslc_qmDomainConstants.TESTPLAN_LOCALNAME + "</a>" + "'}",
        responses = {@ApiResponse(description = "default response",
            content = {@Content(mediaType = OslcMediaType.APPLICATION_RDF_XML), @Content(
                mediaType = OslcMediaType.APPLICATION_XML), @Content(
        ...
        ) throws IOException, ServletException
    {
        ...
        // End of user code
        final TestPlan originalResource = delegate.getTestPlan(httpServletRequest, spSlug, id);

        if (originalResource != null) {
            final String originalETag = delegate.getETagFromTestPlan(originalResource);

            if ((eTagHeader == null) || (originalETag.equals(eTagHeader))) {
                // Start of user code updateTestPlan
                // End of user code
                final TestPlan updatedResource = delegate.updateTestPlan(httpServletRequest, aResource, spSlug, id);
                httpServletResponse.setHeader("ETag", delegate.getETagFromTestPlan(updatedResource));
                return Response.ok().header(ServerConstants.HDR_OSLC_VERSION, ServerConstants.OSLC_VERSION_V2).build();
            }
            else {
