...
public class Execution_recordsService
{
                                                    ...
                                                    @QueryParam("limit") final String limitString) throws IOException, ServletException
    {
        ...
        final List<TestExecutionRecord> resources = QMManager.queryTestExecutionRecords(httpServletRequest, where, page, limit);
    ...
    public TestExecutionRecord getTestExecutionRecord(
                @PathParam("testExecutionRecordId") final String testExecutionRecordId
        ) throws IOException, ServletException, URISyntaxException
    {
        // Start of user code getResource_init
        // End of user code

        final TestExecutionRecord aTestExecutionRecord = QMManager.getTestExecutionRecord(httpServletRequest, testExecutionRecordId);
