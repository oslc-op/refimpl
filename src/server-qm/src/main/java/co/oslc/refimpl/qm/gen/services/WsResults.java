...
public class WsResults
{
        ...
        ) throws IOException, ServletException, URISyntaxException
    {
        ...
        final TestResult aTestResult = OSLCQMServer2020RefImplManager.getTestResult(httpServletRequest, spSlug, id);

        if (aTestResult != null) {
            // Start of user code getTestResult
            // End of user code
            httpServletResponse.setHeader("ETag", OSLCQMServer2020RefImplManager.getETagFromTestResult(aTestResult));
