...
<nav class="navbar sticky-top navbar-light bg-light">
  <div class="container">
  <a class="navbar-brand" href="<c:url value="/services/catalog/singleton"/>">RM</a>
  </div>
</nav>
...
<div class="container">
    <div class="page-header">
        ...
        <div>
          ...
          <dl class="row">
            <dt  class="col-sm-2 text-right">elaboratedBy</dt>
            <dd class="col-sm-9">
            <ul>
            <%
          ...
          <dl class="row">
            <dt  class="col-sm-2 text-right">elaborates</dt>
            <dd class="col-sm-9">
            <ul>
            <%
          ...
          <dl class="row">
            <dt  class="col-sm-2 text-right">specifiedBy</dt>
            <dd class="col-sm-9">
            <ul>
            <%
          ...
          <dl class="row">
            <dt  class="col-sm-2 text-right">specifies</dt>
            <dd class="col-sm-9">
            <ul>
            <%
          ...
          <dl class="row">
            <dt  class="col-sm-2 text-right">affectedBy</dt>
            <dd class="col-sm-9">
            <ul>
            <%
          ...
          <dl class="row">
            <dt  class="col-sm-2 text-right">trackedBy</dt>
            <dd class="col-sm-9">
            <ul>
            <%
          ...
          <dl class="row">
            <dt  class="col-sm-2 text-right">implementedBy</dt>
            <dd class="col-sm-9">
            <ul>
            <%
          ...
          <dl class="row">
            <dt  class="col-sm-2 text-right">validatedBy</dt>
            <dd class="col-sm-9">
            <ul>
            <%
          ...
          <dl class="row">
            <dt  class="col-sm-2 text-right">satisfiedBy</dt>
            <dd class="col-sm-9">
            <ul>
            <%
          ...
          <dl class="row">
            <dt  class="col-sm-2 text-right">satisfies</dt>
            <dd class="col-sm-9">
            <ul>
            <%
          ...
          <dl class="row">
            <dt  class="col-sm-2 text-right">decomposedBy</dt>
            <dd class="col-sm-9">
            <ul>
            <%
          ...
          <dl class="row">
            <dt  class="col-sm-2 text-right">decomposes</dt>
            <dd class="col-sm-9">
            <ul>
            <%
          ...
          <dl class="row">
            <dt  class="col-sm-2 text-right">constrainedBy</dt>
            <dd class="col-sm-9">
            <ul>
            <%
          ...
          <dl class="row">
            <dt  class="col-sm-2 text-right">constrains</dt>
            <dd class="col-sm-9">
            <ul>
            <%
