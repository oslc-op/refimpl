...
<%
  List<ChangeNotice> resources = (List<ChangeNotice>) request.getAttribute("resources");
...
<head>
  ...
  <title>Query capability ChangeNotice QC</title>
...
<!-- Fixed navbar -->
  ...
  <div class="container">
    <div class="page-header">
      <h1>Query Capability &quot;ChangeNotice QC&quot; results</h1>
      <div class="alert alert-secondary" role="alert">
        ...
        <% for (ChangeNotice aResource : resources) { %>
