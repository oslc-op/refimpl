...
if (request.getParameter("resourceUri") != null) {
    aResource = new ChangeNotice (new URI(request.getParameter("resourceUri")));
}
else {
    if (request.getAttribute("aChangeNotice") != null) {
        aResource = (ChangeNotice) request.getAttribute("aChangeNotice");
    }
}

if (asLocalResource != null && asLocalResource.equalsIgnoreCase("true")) {
    out.write("{a Local ChangeNotice Resource} - update ChangeNotice.toString() to present resource as desired.");
}
else {
    if (aResource == null) {
