...
Task aResource = null;
if (request.getAttribute("aTask") != null) {
    aResource = (Task) request.getAttribute("aTask");
}
else {
    if (request.getParameter("resourceUri") != null) {
        aResource = new Task (new URI(request.getParameter("resourceUri")));
    }
}

if (asLocalResource != null && asLocalResource.equalsIgnoreCase("true")) {
    out.write("{a Local Task Resource} - update Task.toString() to present resource as desired.");
}
else {
    if (aResource == null) {
