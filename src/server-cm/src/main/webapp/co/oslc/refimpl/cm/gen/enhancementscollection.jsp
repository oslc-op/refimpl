...
<%
  List<Enhancement> resources = (List<Enhancement>) request.getAttribute("resources");
...
<head>
  ...
  <title>Query capability Enhancement QC</title>
...
<!-- Fixed navbar -->
  ...
  <div class="container">
    <div class="page-header">
      <h1>Query Capability &quot;Enhancement QC&quot; results</h1>
      <div class="alert alert-secondary" role="alert">
        ...
        <% for (Enhancement aResource : resources) { %>
