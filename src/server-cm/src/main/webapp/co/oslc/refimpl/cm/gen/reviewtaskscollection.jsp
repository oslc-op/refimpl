...
<%
  List<ReviewTask> resources = (List<ReviewTask>) request.getAttribute("resources");
...
<head>
  ...
  <title>Query capability Review QC</title>
...
<!-- Fixed navbar -->
  ...
  <div class="container">
    <div class="page-header">
      <h1>Query Capability &quot;Review QC&quot; results</h1>
      <div class="alert alert-secondary" role="alert">
        ...
        <% for (ReviewTask aResource : resources) { %>
