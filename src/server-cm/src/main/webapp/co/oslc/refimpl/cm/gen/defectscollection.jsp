...
<%
  List<Defect> resources = (List<Defect>) request.getAttribute("resources");
...
<head>
  ...
  <title>Query capability Defect QC</title>
...
<!-- Fixed navbar -->
  ...
  <div class="container">
    <div class="page-header">
      <h1>Query Capability &quot;Defect QC&quot; results</h1>
      <div class="alert alert-secondary" role="alert">
        ...
        <% for (Defect aResource : resources) { %>
