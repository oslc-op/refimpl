...
<%
  List<Task> resources = (List<Task>) request.getAttribute("resources");
...
<head>
  ...
  <title>Query capability Task QC</title>
...
<!-- Fixed navbar -->
  ...
  <div class="container">
    <div class="page-header">
      <h1>Query Capability &quot;Task QC&quot; results</h1>
